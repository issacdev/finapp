...
public class YahooExtractor extends AExtractor{
	
	private int skip = 20000; 
	private String searchKey = "<div> <span class=\"time_rtq_ticker\"><span>";
	
	public static Logger log = Logger.getLogger(AastocksExtractor.class.getName());
	
	public void run() throws Exception{
		
		System.out.println("#### YAHOO EXTRACTOR");
		...
		for(StockMaster master : masterList){
			...
			//Stock Key
			String tempUrl = url.replace("##STOCK_CODE##", master.getStockKey());
	        String inputLine;
